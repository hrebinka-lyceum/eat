...
export const qk = {
  ...
  ordersByDish: (from: string, to: string) => ['stats', 'orders-by-dish', from, to] as const,
  classCoverage: (from: string, to: string) => ['stats', 'class-coverage', from, to] as const,
  dailyTotals: (from: string, to: string) => ['stats', 'daily-totals', from, to] as const,
  costRows: (from: string, to: string) => ['stats', 'cost-rows', from, to] as const,
